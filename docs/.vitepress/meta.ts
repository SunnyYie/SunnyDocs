...
export const name = 'SunnyDocs';
export const site = 'https://SunnyDocs.cn/';
export const logo = '📒';
...
export const description = '全方位全栈开发平台，涵盖React与NestJS学习路径，构建完整知识体系，汇聚海量实战案例与面试秘籍，享受一体化学习体验。紧跟技术潮流，深入探索React，同时精通NestJS后端框架，实现前后端无缝衔接，助力您从广度到深度，全面升级全栈开发技能';

export const bilibili = 'https://space.bilibili.com/687804751'
export const github = 'https://github.com/SunnyYie/SunnyDocs'
